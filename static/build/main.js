        ...
        const applyCustomClass = (elem, params, className) => {
          ...
          if (params.customClass && params.customClass[className]) {
            if (typeof params.customClass[className] !== "string" && !params.customClass[className].forEach) {
              warn3(`Invalid type of customClass.${className}! Expected string or iterable object, got "${typeof params.customClass[className]}"`);
              return;
            }
...
`.replace(/(^|\n)\s*/g, "");
        ...
        function handlePositionParam(container, position) {
          if (position in swalClasses) {
            ...
            warn3('The "position" parameter is not valid, defaulting to "center"');
        ...
        const renderInput = (instance, params) => {
          ...
          const rerender2 = !innerParams || params.input !== innerParams.input;
        ...
        const checkAndSetInputValue = (input, inputValue) => {
          if (["string", "number"].includes(typeof inputValue)) {
            ...
            warn3(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof inputValue}"`);
          }
        };
...
`;
        ...
        const renderProgressSteps = (instance, params) => {
          ...
          if (params.currentProgressStep >= params.progressSteps.length) {
            warn3("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)");
          }
        ...
        const checkIfParamIsValid = (param) => {
          if (!isValidParameter(param)) {
            warn3(`Unknown parameter "${param}"`);
          }
        };
        const checkIfToastParamIsValid = (param) => {
          if (toastIncompatibleParams.includes(param)) {
            warn3(`The parameter "${param}" is incompatible with toasts`);
          }
        };
        ...
        const showWarningsForParams = (params) => {
          if (params.backdrop === false && params.allowOutsideClick) {
            warn3('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
          }
        ...
        function update(params) {
          ...
          if (!popup || hasClass(popup, innerParams.hideClass.popup)) {
            warn3(`You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.`);
            return;
          }
        ...
        const filterValidParams = (params) => {
          ...
          Object.keys(params).forEach((param) => {
            if (isUpdatableParameter(param)) {
              ...
              warn3(`Invalid parameter to update: ${param}`);
            }
          });
        ...
        const showWarningsForElements = (templateContent) => {
          ...
          Array.from(templateContent.children).forEach((el) => {
            ...
            if (!allowedElements.includes(tagName)) {
              warn3(`Unrecognized element <${tagName}>`);
            }
          });
        };
        const showWarningsForAttributes = (el, allowedAttributes) => {
          Array.from(el.attributes).forEach((attribute) => {
            if (allowedAttributes.indexOf(attribute.name) === -1) {
              warn3([`Unrecognized attribute "${attribute.name}" on <${el.tagName.toLowerCase()}>.`, `${allowedAttributes.length ? `Allowed attributes are: ${allowedAttributes.join(", ")}` : "To set the value, use HTML within the element."}`]);
            }
          });
        };
        ...
        function validateCustomTargetElement(params) {
          if (!params.target || typeof params.target === "string" && !document.querySelector(params.target) || typeof params.target !== "string" && !params.target.appendChild) {
            warn3('Target parameter is not valid, defaulting to "body"');
            params.target = "body";
          }
        }
        function setParameters(params) {
          ...
          if (params.showLoaderOnConfirm && !params.preConfirm) {
            warn3("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request");
          }
        ...
        class SweetAlert {
          ...
          _main(userParams) {
            ...
            render2(currentInstance2, innerParams);
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
    ...
    filesize(size2) {
      ...
      if (size2 > 0) {
        ...
        for (let i = 0; i < units.length; i++) {
          ...
          if (size2 >= cutoff) {
            selectedSize = size2 / Math.pow(this.options.filesizeBase, 4 - i);
            selectedUnit = unit;
            break;
          }
        }
  ...
  // sfc-script:/home/sabmodem/projects/filestorage/src/App.vue?type=script
  ...
  var App_default = {
    ...
    methods: {
      async getFilesList() {
        const files = await axios_default.get("/files");
      ...
      async deleteFile(file) {
        ...
        if (result.isConfirmed) {
          await axios_default.delete(`/files/${file.filename}`);
          await this.getFilesList();
          await import_sweetalert2.default.fire("\u0414\u0430\u043D\u043D\u044B\u0435 \u0443\u0434\u0430\u043B\u0435\u043D\u044B", "", "success");
        }
        ;
      },
      viewFile(file) {
    ...
    async mounted() {
      await this.getFilesList();
      const dz = new $3ed269f2f0fb224b$export$2e2bcd8739ae039("form#muf", {
        url: "/files",
        method: "post",
        maxFilesize: 1024,
        uploadMultiple: true,
  ...
  // sfc-template:/home/sabmodem/projects/filestorage/src/App.vue?type=template
  var _hoisted_1 = { class: "container" };
  var _hoisted_2 = /* @__PURE__ */ createBaseVNode(
    "div",
    { class: "d-flex justify-content-center" },
    [
      /* @__PURE__ */ createBaseVNode("div", { class: "d-flex flex-column" }, [
        /* @__PURE__ */ createBaseVNode("div", { class: "d-flex justify-content-center" }, [
          /* @__PURE__ */ createBaseVNode("h1", null, "\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0444\u0430\u0439\u043B:")
        ]),
  ...
  var _hoisted_3 = { class: "mt-3" };
  var _hoisted_4 = /* @__PURE__ */ createBaseVNode(
    "div",
    { clas: "row" },
    [
      /* @__PURE__ */ createBaseVNode("div", { class: "col text-center" }, [
        /* @__PURE__ */ createBaseVNode("h1", null, "\u0414\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0435 \u0444\u0430\u0439\u043B\u044B:")
      ])
    ],
    -1
    /* HOISTED */
  ...
  var _hoisted_6 = /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("h1", null, "\u041D\u0435\u0442 \u0444\u0430\u0439\u043B\u043E\u0432")
    ],
    -1
    /* HOISTED */
  );
  ...
  var _hoisted_9 = { class: "col-md-6 text-center" };
  var _hoisted_10 = { class: "col-md-6 text-center" };
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_1, [
      ...
      createBaseVNode("div", _hoisted_3, [
        _hoisted_4,
        $data.files.length == 0 ? (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_7)) : createCommentVNode("v-if", true),
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList($data.files, (file) => {
              ...
              createBaseVNode("div", _hoisted_8, [
                ...
                createBaseVNode("div", _hoisted_10, [
                  ...
                  createBaseVNode("button", {
                    ...
                    onClick: ($event) => $options.deleteFile(file)
